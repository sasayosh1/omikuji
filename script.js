// --- Data ---
const fortunes = [
  { name: "大吉", lead: "とよのぶを完全に論破できる日。あなたの正論がとよのぶを貫き、最高の気分で一日を過ごせるでしょう。", weight: 15, intensity: 3 },
  { name: "中吉", lead: "とよのぶのボケを華麗にスルーできる運気。冷静な対応が周囲の評価を爆上げします。", weight: 25, intensity: 2 },
  { name: "小吉", lead: "とよのぶの無茶振りを適当にいなせる時。省エネ運転で、自分の時間を大切にしましょう。", weight: 30, intensity: 1 },
  { name: "吉", lead: "とよのぶにちょっとだけ優しくなれる日。たまにはお菓子でもあげると、運気が安定します。", weight: 20, intensity: 1 },
  { name: "末吉", lead: "とよのぶの長話に捕まりそうな予感。隙を見て逃げ出す勇気が、今日の吉凶を分けます。", weight: 10, intensity: 1 }
];
